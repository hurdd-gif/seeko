 ...
 *
 *  Admin-facing mirror of the investor panel: completion ring + game-area
 *  progress + recent activity. Investors reach the same view via /investor.
 * ───────────────────────────────────────────────────────── */
...
export default async function ProgressPage() {
  ...
  if (!isAdmin && !isInvestor) redirect('/');
  ...
  // Shared surface style matching the rest of the dashboard
    ...
    <div className="flex flex-col gap-6">
      ...
      <FadeRise delay={delay(TIMING.hero)} className="pb-2">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Overall completion, area progress, and recent activity.
        </p>
      </FadeRise>

      {/* ── KPI Strip (completion ring) ──────────────────── */}
      <InvestorKPIStrip
