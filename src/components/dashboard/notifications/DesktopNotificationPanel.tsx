        ...
        {open && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3">
              <h3 className="text-[14px] font-medium tracking-[-0.28px] text-ink-title">Inbox</h3>
              {unreadCount > 0 && (
                <button
                  onClick={onMarkAllRead}
                  className="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1 text-[13px] text-ink-muted hover:bg-wash-4 hover:text-ink-title transition-colors"
                >
