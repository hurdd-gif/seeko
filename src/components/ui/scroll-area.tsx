          ...
          <ScrollbarVisibleContext.Provider value={hovering || scrolling}>
            ...
            >
              <ScrollAreaPrimitive.Viewport
                ...
                // Radix wraps children in a `display:table` div so horizontal
                // content can size past the viewport — but in vertical-only
                // areas that same table lets flex rows expand to min-content,
                // clipping their right edge and defeating `truncate`. Force it
                // to block when we never scroll horizontally.
                className={cn(
                  "size-full rounded-[inherit]",
