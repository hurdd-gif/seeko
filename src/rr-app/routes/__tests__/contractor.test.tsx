...
const ready: ContractorOverviewData = {
  ...
  deliverables: [
    { id: 'a', name: 'Main menu wireframes', department: 'UI/UX', status: 'In Progress', priority: 'High', deadline: '2026-07-10', progress: 45, description: null, latestExtension: null, steps: [] },
  ],
};
